...
import { Separator } from "@/components/ui-tools/ui/separator";
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from "@/components/ui-tools/ui/sheet";
import { Skeleton } from "@/components/ui-tools/ui/skeleton";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/ui-tools/ui/tooltip";
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-card-main text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width,opacity] duration-300 ease-in-out",
