  ...
  "inline-flex items-center justify-center cursor-pointer gap-2 whitespace-nowrap text-white  text-sm font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline: "border hover:text-accent text-black rounded-soft",
        grayFill: "bg-black/6 text-title hover:bg-black/8 rounded-soft",
        transparent: "bg-transparent hover:bg-black/5 text-black rounded-soft",
        link: "hover:opacity-80 underline text-accent text-lg bg-transparent rounded-soft",
