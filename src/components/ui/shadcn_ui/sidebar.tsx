...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from "@/components/ui/shadcn_ui/sheet";
import { Skeleton } from "@/components/ui/shadcn_ui/skeleton";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/ui/shadcn_ui/tooltip";
...
function Sidebar({
  ...
  return (
    <div
      className="group peer text-sidebar-foreground hidden md:block bg-card-main"
      data-state={state}
