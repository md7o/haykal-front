  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        // Apply dark style only when open
        "data-[state=open]:bg-black/80 data-[state=open]:text-white data-[state=open]:border-white/20 data-[state=open]:hover:bg-black/70",
        className
      )}
      {...props}
    >
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          // Black translucent dropdown with white text
