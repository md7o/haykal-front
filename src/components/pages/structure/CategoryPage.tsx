...
export default function CategoryPage() {
  ...
  const categoryType = [
    ...
    },
    {
      ...
      name: "Creator",
      description:
        "Showcase merch, sponsors, and embed content (videos, photo).",
  ...
  return (
    ...
    >
      <div className="text-center mt-10">
        ...
        <p className="text-description mb-10 text-lg md:text-2xl ">
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 max-w-6xl mx-auto">
          {categoryType.map((cat) => (
            ...
            >
              ...
              <div
                className={`absolute top-8 right-8 text-white drop-shadow-lg transition-all ${duration} `}
              >
                {cat.icon}
              </div>
