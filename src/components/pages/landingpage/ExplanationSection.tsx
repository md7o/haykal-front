...
const featuresList = [
  {
    icon: User,
    title: "Personal",
    description: "Resume style sections for work, education, skills + contact & socials.",
    color: "text-blue-500",
  },
  {
    icon: BriefcaseBusiness,
    title: "Business",
    description: "Client focused layouts with testimonials, services, booking, and pricing.",
    color: "text-orange-600",
  },
  {
    icon: CirclePlay,
    title: "Creator",
    description: "Showcase merch, sponsors, and embed content (videos, blogs, podcasts).",
    color: "text-red-400",
  },
];
    ...
    <section className="bg-primary w-full">
      ...
      >
        <div className="relative max-w-lg space-y-5">
          <h1 className="text-title sm:text-5xl text-4xl font-bold relative">Pick & Customize Sections</h1>
          <p className="text-description">Simple steps to create you portfolio</p>
          <Image
      ...
      >
        <div className="relative max-w-md space-y-5">
          <h1 className="text-title sm:text-5xl text-4xl font-bold relative">Choose Your Space To Fit Your Experience</h1>
              ...
              <li key={index} className="flex flex-col items-left space-x-3">
                <div className="flex flex-row items-start gap-3">
                  ...
                  <div className="flex flex-col text-left">
                    <span className="text-xl text-title font-bold">{feature.title}</span>
                    <span className="text-description">{feature.description}</span>
                  </div>
                </div>
              </li>
            ))}
